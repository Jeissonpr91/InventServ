        ...
        return (
            <div className="col-md-6 offset-md-3">
                <div className="card card-body">
                    ...
                    {/* Contenido */}
                    <div className="form-group">
                        <textarea name="content" className="form-control" placeholder="Descripción:" 
                    ...
                    {/* Cantidad */}
                    <div className="form-group">
                        <input type='number' name="cantidad" className="form-control" placeholder="Cantidad:" 
                        onChange={this.onInputChange} value={this.state.cantidad} required></input>
                    </div>
                    <br/>
